...
export var customerData:customerDataType[] = [
  ...
  export const addCustomer = (data:customerDataType) => {
    customerData.push(data)
  }
  
  export const editCustomer = (data:customerDataType) => {
  ...
  export const deleteCustomer = (email:string) => {
    customerData = customerData.filter((customer) => customer.email !== email)
  }
